...
# Read data from the sheet "Group2"
data <- read_excel(path = file_path, sheet = "Group2")
str(data)

colnames(data) <- c("Group2","Participant_Number","Gender","Age_Group","Age","Explanation_satisfaction_Scale","Trust_Scale","Fluency_of_interaction","Adaptability")
