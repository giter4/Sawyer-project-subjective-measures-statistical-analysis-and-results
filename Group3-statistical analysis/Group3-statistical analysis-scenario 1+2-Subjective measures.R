...
# Read data from the sheet "Group3"
data <- read_excel(path = file_path, sheet = "Group3")
str(data)

colnames(data) <- c("Group3","Participant_Number","Gender","Age_Group","Age","Explanation_satisfaction_Scale","Trust_Scale","Fluency_of_interaction","Adaptability")
